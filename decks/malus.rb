...
malus = [
    'Le secteur des nouvelles technologies représente à lui seul, entre 6 à 10% de la consommation mondiale d'électricité selon les estimations (env 4% toute énergie)', [1]
    ...
    ' Sur quantité de métaux d'un smartphone,  0,1 % de terres rares et métaux spéciaux : europium, yttrium, terbium, gallium, tungstène, etc.', [36]
    ...
    'Un phénomène connu sous le nom de "nomophobie" décrit la peur excessive à l’idée de perdre ou d’être séparé de son téléphone portable. ', [50]
]
