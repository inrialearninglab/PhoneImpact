...
* Le rapport RECORD
* MineralInfo
* Le rapport Safety is no accident
* Le papier RMR
* L'elementarium ?
## À rajouter plus tard

* Ajouter la figure avec l'évolution du nombre de métaux dans les smartphones.
## Des questions en suspens

* C'est quoi exactement la céramique ? 
* Et les PCB c'est en plastique ?
* Définition de métal : élément du tableau périodique versus notion physique
* Métaux lourds : quel lien entre masse atomique et le tableau périodique ?
...
* wafer
* batteries
* production de vibrations pour les aimants
* connexion entre transistors
* isolation
* condensateurs

**Propriétés recherchées**
* conductivité
* haut point de fusion (what for?!?)
