...
Les métaux de base représentent la majeure partie du poids des métaux dans un smartphone.
...
**Métaux précieux**
   ...
   Les métaux précieux (ex. argent, or, palladium, platine) représentent environ 0,5 % (en poids) de la totalité des métaux. Ils sont utilisés principalement pour leur conductivité et leur résistance à la corrosion.

**Métaux de spécialité**

La présence d'un grand nombre de ces métaux, parfois en très petite quantité, illustre la grande diversité des fonctionnalités spécifiques qu'ils permettent d'implémenter.

* Les terres rares (ex. néodyme, yttrium) représentent moins de 0,1% (en poids) des métaux dans un smartphone. Ce sont des métaux chimiquement assez réactifs et disposant de propriétés électromagnétiques, électroniques, magnétiques, optiques ou encore catalytiques les rendant indispensables pour des fabrications de haute technologie. Elles servent entre autres à fabriquer les aimants pour les vibreurs des smartphones et à colorer les LED des écrans. 
* Le silicium
