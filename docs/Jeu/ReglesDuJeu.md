...
!!! example "Par exemple"
    ...
    2 cartes visibles et 1 dans la pioche. Une fois que vous avez pris vos cartes, vous remplacez les emplacements vides par de nouvelles cartes.

- Si vous choisissez PolluMoins, c’est le même principe, mais vous ne prenez que 2 cartes au total.

!!! example "Par exemple"

    1 carte visible et 1 carte dans la pioche puis vous remplacez les cartes prises.

- Si vous choisissez Recycl, vous ne prenez qu’une seule carte, visible ou dans la pioche.

!!! example "Par exemple"

    1 carte visible, puis vous la remplacez immédiatement.
...
!!! example "Par exemple"
    ...
    Je m’approvisionne chez PolluPlus, je prends au total 3 cartes ressources.

!!! info "Pour info"

    **une carte récapitulative à côté de chaque fournisseur vous indique la composition de sa pioche.** 
...
!!! example "Par exemple"
    ...
    Si vous avez 2 métaux communs, 1 autre métal et 1 autre matière, vous pouvez déposer les cartes sur le composant batterie, ce qui vous rapportera 6 points à la fin de la partie.

Chaque composant ne peut être construit qu’**une seule fois**. On ne peut fabriquer qu’**un seul composant par tour de jeu**.

### 3. Action : dépolluer

Défaussez **1 à 2 cartes Malus** de votre main. Ces cartes ne sont pas remises dans la pioche et sont mises de côté.
