...
!!! Information
    Si vous avez un peu de temps, vérifier que les ressources sont bien mélangées. N’hésitez pas à les retrier manuellement si nécessaire.
...
À gauche de chaque pioche, <span style="color: #7F88E6; font-weight: bold; border: 1.5px solid #7F88E6; border-radius: 50%; padding: 1px 4px; display: inline-flex; align-items: center; justify-content: center; font-size: 12px; line-height: 1;">5</span> disposez les cartes **Synthèse des ressources** correspondantes à chaque fournisseur.

## Étape 3 - les cartes malus
...
Pour cela, mettez **les cartes numérotées `1/6` à `6/6`** de côté. 
...
Mélangez la pile constituée puis placez sur le dessus le paquet composé des cartes de `1/6` à `6/6`, de façon à ce que la carte `1/6` soit en haut de la pile.
